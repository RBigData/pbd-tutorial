...
\begin{frame}{\pbdR Interfaces to Libraries: Sustainable Path}
  ...
  \begin{block}{Why use HPC libraries?}
    ...
    \item 30+ years of building libraries
...
\begin{frame}
  \begin{block}{pbdMPI: new High Level Interface to MPI}
    \begin{itemize}
...
[1] TRUE
    \end{lstlisting}
  \end{block}
  \begin{block}{pbdMPI lets the machine figure it out}\pause
...
\begin{frame}{Distributed Dense Matrix and Vector Operations for Analytics}
